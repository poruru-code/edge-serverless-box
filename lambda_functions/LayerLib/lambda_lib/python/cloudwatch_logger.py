...
class CloudWatchLogClient(LogClientAdapter):
    ...
    def put_large_data(self, user_name: str, item_name: str, message: str) -> str:
        ...
        file_name = f"{user_name}.{item_name}.{dt_now.strftime('%Y%m%d%H%M%S%f')[:-3]}.{stream_name}.log"
...
class CloudWatchLogger:
    def __init__(self, user_name: str):
        ...
        self.is_output_debug_large_data = os.environ.get(ENVIRON_LOG_DEBUG_LARGE_DATA, '').lower() == 'true'
